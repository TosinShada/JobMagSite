...
using JobMagSite.Domain.Settings;
using JobMagSite.Infrastructure.Configs;
using FluentValidation.AspNetCore;
using JobMagSite.Service.Contract;
using JobMagSite.Service.Implementation;
using System;
...
namespace JobMagSite.Infrastructure.Extension
{
            ...
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "Job Mag Site",
                        Version = "1",
                        Description = "A pet project to create a job site",
                        Contact = new OpenApiContact()
                        {
                            Email = "tosinshada@gmail.com",
                            Name = "Tosin Shada",
                            Url = new Uri("https://github.com/TosinShada")
                        },
